                    ...
                    <div class="user-area" edit-area>
                        <ul>
                            <li class="box box-horizontal">
                                <p class="name">昵称：</p>
                                <div class="text box1"><$var userinfo.NickName></$var></div>
                                <div class="edit-box box1">
                                    <div class="inputbox">
                                        <input type="text" value="<$var userinfo.NickName></$var>" name="" id="" placeholder="粉红猪" validate="">
                                    </div>
                                </div>
                            </li>
                            <!--<li class="box box-horizontal">
                                <p class="name">姓名：</p>
                                <div class="text box1">粉红猪</div>
                                <div class="edit-box box1">
                                    <div class="inputbox">
                                        <input type="text" value="<$var userinfo.name></$var>" name="Name" id="Name" placeholder="请输入真实姓名" maxlength="20">
                                    </div>
                                </div>
                            </li>-->
                            <li class="box box-horizontal">
                                <p class="name">生日：</p>
                                <div class="text box1"><$var userinfo.BirthYear />-<$var userinfo.BirthMonth />-<$var userinfo.BirthDay /></div>
                                <div class="edit-box box1">
...
<script type="text/javascript">
    $e(function () {
        var json = $e.parseJSON('<$var UserInfoJson/>');
...
<script type="text/javascript" language="javascript" charset="utf-8">
    ...
    var editUserInfo = function (obj) {
        ...
        if (obj.getAttribute('edit') === 'off') {
            for (; i < edit_panel.length; i++) {
                $e(edit_panel[i]).removeClass('edit');
            }
        } else {
            for (; i < edit_panel.length; i++) {
                $e(edit_panel[i]).addClass('edit');
            }
        }
    ...
    var cancel = function () {
        console.log($e("a[edit='on']"));
        editUserInfo($e("a[edit='on']")[0]);
    }
</script>
